		...
		<div class="container">
			<div class="footer__row">
				<div class="footer__col">
					<div class="footer__heading">Płatność</div>
				...
				<div class="footer__col">
					<div class="footer__heading">Dostawa</div>
					<ul class="footer__nav">
						<li class="footer__nav-item">
							Kurier InPost 
						</li>
				...
				<div class="footer__col">
					<div class="footer__heading">Autor</div>
					<ul class="footer__nav">
						<li class="footer__nav-item">
							<a href="https://pankobus.pl/o-mnie/" 
								class="link" target="_blank" rel="nofollow noopener">
								O Autorze
							</a>
						</li>
						<li class="footer__nav-item">
							<a href="https://pankobus.pl/" 
								class="link" target="_blank" rel="nofollow noopener">
								Blog
							</a>
						</li>
				...
				<div class="footer__col footer__col_big">
					<div class="footer__heading">Znajdziesz mnie na</div>
					<ul class="social">
			...
			<div class="footer__row footer__row_copy">
				<div class="footer__col">
					<a href="#" class="link">Regulamin sklepu</a>
				</div>
				<div class="footer__col">
				...
				<div class="foot__copy">
					<a class="logo logo_small" href="#">
						<img src="<?php echo ASSETS . '/images/logo.png' ?>" class="img-fluid" 
								width="97" height="47" alt="">
					</a>
					Wszelkie prawa zastrzeżone © 2023
				</div>
			</div>
			<div class="footer__row footer__row_logos">
				<div class="footer__col">
					<div class="logos">
						<a href="https://inpost.pl/" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/paczkomaty.png' ?>" class="img-fluid" width="50" height="31" alt="">
						</a>
						<a href="https://inpost.pl/" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/inpost.png' ?>" class="img-fluid" width="52" height="31" alt="">
						</a>
						<a href="https://www.poczta-polska.pl/paczki-i-listy/przesylki-zagraniczne/listy/global-expres/" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/global-expres.png' ?>" class="img-fluid" width="60" height="30" alt="">
						</a>
					</div>
				</div>
				<div class="footer__col footer__col_big">
					<div class="logos">
						<a href="https://www.przelewy24.pl/" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/przelewy24.png' ?>" class="img-fluid" width="82" height="28" alt="">
						</a>
						<a href="https://www.visa.pl/" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/visa.png' ?>" class="img-fluid" width="99" height="30" alt="">
						</a>
						<a href="https://www.paypal.com/pl/home" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/paypal.png' ?>" class="img-fluid" width="82" height="24" alt="">
						</a>
						<a href="https://www.blik.com/" class="footer-logo" target="_blank">
							<img src="<?php echo ASSETS . '/images/logos/blik.png' ?>" class="img-fluid" width="57" height="28" alt="">
						</a>
					</div>
				</div>
			</div>
