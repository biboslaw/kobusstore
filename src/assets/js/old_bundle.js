...
(function (global, factory) {
 ...
 /* harmony import */ var swiper_css_zoom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! swiper/css/zoom */ "./node_modules/swiper/modules/zoom/zoom.min.css");
 /* harmony import */ var swiper_scss_effect_fade__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! swiper/scss/effect-fade */ "./node_modules/swiper/modules/effect-fade/effect-fade.scss");
 ...
 smoothscroll_polyfill__WEBPACK_IMPORTED_MODULE_8___default().polyfill();
 ...
 const app = {
     initSwipers: () => {
         ...
         swipers.forEach((el) => {
             const swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](el, {
                 modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_1__.FreeMode],
                 simulateTouch: true,
                 slidesPerView: el.getAttribute('data-swiper-slides-mobile') || 2,
                 spaceBetween: 16,
                 autoHeight: true,
                 freeMode: {
                     enabled: true,
                 ...
                 breakpoints: {
                     ...
                     1280: {
                         slidesPerView: el.getAttribute('data-swiper-slides') || 1,
                         spaceBetween: 0,
                     },
                 },
             });
     ...
     initToggle: () => {
         ...
         const clickHandler = (e) => {
             ...
             const wrapEl = thisEl.closest('.js-toggle-wrapper');
 
             if (wrapEl) {
                 wrapEl.querySelectorAll('.js-toggle-button').forEach((el) => {
                     if (el !== thisEl) {
                         el.classList.remove('wow-active');
                     }
                 });
             }
 
             thisEl.classList.toggle('wow-active');
 
             console.log(thisEl.getAttribute('data-noscroll'));
 
             if (!thisEl.getAttribute('data-noscroll')) {
                 let posTop = thisEl.offsetTop;
 
                 if (window.innerWidth < 1280) {
                     posTop -= document.querySelector('.navbar').offsetHeight;
                 }
                 scroll({
                     top: posTop,
                     behavior: 'smooth',
     ...
     initScrollTo: () => {
         ...
         const clickHandler = (e) => {
             ...
             const setEl = document.querySelector(href);
             let posTop = setEl.offsetTop;
 
             if (window.innerWidth < 1280) {
                 posTop -= document.querySelector('.navbar').offsetHeight;
                 document.querySelector('.button-icon_nav').click();
             }
     ...
     initProduct: () => {
         var swiperThumbs = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.js-swiper-thumbs', {
         ...
         var swiperThumb = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.js-swiper-thumb', {
             modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_1__.Zoom, swiper__WEBPACK_IMPORTED_MODULE_1__.EffectFade],
             effect: 'fade',
             autoHeight: true,
             touchRatio: 0,
             fadeEffect: {
     ...
     initQuantity: () => {
         ...
         const clickHandler = (e) => {
             ...
             const inputEl = parentEl.querySelector('.wow-quantity__field');
         ...
         const blurHandler = (e) => {
             const thisEl = e.target;
             const thisValueNumber = Number(thisEl.value);
     ...
     initMobileMenu: () => {
         const btn = document.querySelector('.button-icon_nav');
         const clickHandler = (e) => {
             e.preventDefault();
             btn.classList.toggle('wow-active');
             document.querySelector('.nav-overlay').classList.toggle('wow-active');
         };
     ...
     form: () => {
         ...
         const showLabel = (el) => {
             if (el.getAttribute('placeholder')) {
                 ...
                 el.previousElementSibling.classList.add('form-label-show');
             }
         };
         ...
         const blurHandler = (e) => {
             ...
             if (thisEl.value == '') {
                 thisEl.setAttribute('placeholder', thisEl.getAttribute('data-placeholder'));
                 thisEl.removeAttribute('data-placeholder');
                 thisEl.previousElementSibling.classList.remove('form-label-show');
             }
         };
